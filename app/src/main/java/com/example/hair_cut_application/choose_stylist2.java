...
public class choose_stylist2 extends AppCompatActivity {
    ...
    private void addControl() {
        ...
        adapter = new ArrayAdapter(choose_stylist2.this, android.R.layout.simple_list_item_1,list);
        ...
        lvChooseStylist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(choose_stylist2.this, DanhGiaStylist.class);
