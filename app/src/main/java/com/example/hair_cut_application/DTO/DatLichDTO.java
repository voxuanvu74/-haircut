...
public class DatLichDTO {
    ...
    public DatLichDTO(int id, String cuaHangID, String sdt, String tho, String ngay, String gio, String tong, String thoiGianDat) {
        this.id = id;
    ...
    public DatLichDTO(String cuaHangID, String sdt, String tho, String ngay, String gio, String tong, String thoiGianDat) {
        this.cuaHangID = cuaHangID;
        this.sdt = sdt;
        this.ngay = ngay;
        this.gio = gio;
    ...
    public DatLichDTO(String cuaHangID, String sdt, String tho, String ngay, String gio) {
        this.cuaHangID = cuaHangID;
        this.sdt = sdt;
        this.ngay = ngay;
        this.gio = gio;
